...
const AuthorBio = ({ author }) => (
  <div className="bg-surface-white rounded-xl p-6 shadow-[0_10px_25px_rgba(0,0,0,0.04)] flex flex-col gap-4">
    <div className="flex items-center gap-4">
      ...
      <h2 className="font-headline-md text-headline-md text-on-background font-bold leading-snug">
        {author.name}
      </h2>
    </div>
    ...
    {author.contactEmail ? (
      <a
        ...
        className="flex items-center gap-2 text-on-surface-variant hover:text-primary transition-colors font-label-sm text-label-sm"
      >
